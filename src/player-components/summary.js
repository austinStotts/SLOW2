            ...
            <div className="summary-info-wrapper">
                <div className="summary-spread-wrapper">
                    ...
                    <div className="summary-text-wrapper">
                        <div className="summary-name" >{props.favorite ? <span onClick={props.removeFavorite} title="un-favorite" className="star material-symbols-rounded favorite">star</span> : <span onClick={props.addFavorite} title="favorite" className="star material-symbols-rounded">star</span> } <div className="name-text-wrapper"><p className="name-text">{props.data.username}</p></div></div>
