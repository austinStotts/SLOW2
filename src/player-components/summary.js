            ...
            <div className="summary-info-wrapper">
                <div className="summary-spread-wrapper">
                    ...
                    <div className="summary-text-wrapper">
                        <div className="summary-name ">{props.favorite ? <span onClick={props.addFavorite} title="un-favorite" class="star material-symbols-rounded favorite">star</span> : <span onClick={props.addFavorite} title="favorite" class="star material-symbols-rounded">star</span> } {props.data.username}</div>
